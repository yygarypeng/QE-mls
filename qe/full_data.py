...
# TODO: update to mc20 v5 sample (after create reco-truth matched sample)
...
@dataclass
class Truth_lead_nu:
    px = pd.read_hdf(data_path, "TruthNu0")["Px"] * GEV
    py = pd.read_hdf(data_path, "TruthNu0")["Py"] * GEV
    pz = pd.read_hdf(data_path, "TruthNu0")["Pz"] * GEV
    energy = pd.read_hdf(data_path, "TruthNu0")["E"] * GEV
    pt = pd.read_hdf(data_path, "TruthNu0")["Pt"] * GEV
    eta = pd.read_hdf(data_path, "TruthNu0")["Eta"]
    phi = pd.read_hdf(data_path, "TruthNu0")["Phi"]
    p4 = np.array([px, py, pz, energy]).T
    p3 = np.array([px, py, pz]).T

@dataclass
class Truth_sublead_nu:
    px = pd.read_hdf(data_path, "TruthNu1")["Px"] * GEV
    py = pd.read_hdf(data_path, "TruthNu1")["Py"] * GEV
    pz = pd.read_hdf(data_path, "TruthNu1")["Pz"] * GEV
    energy = pd.read_hdf(data_path, "TruthNu1")["E"] * GEV
    pt = pd.read_hdf(data_path, "TruthNu1")["Pt"] * GEV
    eta = pd.read_hdf(data_path, "TruthNu1")["Eta"]
    phi = pd.read_hdf(data_path, "TruthNu1")["Phi"]
    p4 = np.array([px, py, pz, energy]).T
    p3 = np.array([px, py, pz]).T
